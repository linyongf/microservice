...
import com.foundation.mapper.SysDeptMapper;
...
public class SysDeptServiceImpl extends ServiceImpl<SysDeptMapper, SysDept> implements ISysDeptService {
    ...
    public String checkDeptNameUnique(SysDept dept) {
        ...
        if (Objects.nonNull(info) && info.getId().longValue() != deptId.longValue()) {
    ...
    public void checkDeptDataScope(Long deptId) {
        if (!org.apache.commons.lang.StringUtils.equals(UserContextHolder.obtainUserInfo().getUsername(), BasicConstants.SUPERADMIN)) {
...
//        }
    ...
    private void updateParentDeptStatusNormal(SysDept dept) {
        ...
        long[] deptIds = Arrays.stream(ancestors.split(":")).mapToLong(i -> Long.valueOf(i)).toArray();
