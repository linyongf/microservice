...
//        } else {
//            menu.getP.getParams().put("userId", userId);
...
//        }
    ...
    public boolean isInnerLink(SysMenu menu) {
        return menu.getIsFrame().equals(UserConstants.NO_FRAME) && menu.getPath().equals(BasicConstants.HTTP);
    }
    ...
    public String innerLinkReplaceEach(String path) {
        return StringUtils.replaceEach(path, new String[]{BasicConstants.HTTP, BasicConstants.HTTPS},
                new String[]{"", ""});
    }
}
